...
public interface RxBleDevice {
     ...
     *
     * @return observable that will emit {@link io.nrbtech.rxandroidble.RxBleConnection.RxBleConnectionState} changes
     */
     ...
     *                    If false, the connection will fail with {@link io.nrbtech.rxandroidble.exceptions.BleGattException} if
