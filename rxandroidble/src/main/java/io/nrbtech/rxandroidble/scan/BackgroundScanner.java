...
public interface BackgroundScanner {
     ...
     * @throws io.nrbtech.rxandroidble.exceptions.BleScanException thrown if not possible to start the scan
     */
    @RequiresApi(26 /* Build.VERSION_CODES.O */)
     ...
     * @throws io.nrbtech.rxandroidble.exceptions.BleScanException scan failure
     */
