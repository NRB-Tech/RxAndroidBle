...
/**
 * An interface that describes what library extensions should be added to {@link io.nrbtech.rxandroidble.scan.ScanSettings}
 */
public interface ExternalScanSettingsExtension<R extends ExternalScanSettingsExtension<R>> {
    ...
    interface Builder<T extends Builder<T>> {
         ...
         * Some Android devices will not return any {@link io.nrbtech.rxandroidble.scan.ScanResult} if Location Services are
         * disabled.
         *
