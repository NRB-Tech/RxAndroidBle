...
public class ConnectionSetup {
     ...
     * with {@link io.nrbtech.rxandroidble.exceptions.BleGattException} if the device is not in range.
     */
    ...
    public static class Builder {
         ...
         *                    with {@link io.nrbtech.rxandroidble.exceptions.BleGattException} if the device is not in range after a
         *                    30 seconds timeout.
