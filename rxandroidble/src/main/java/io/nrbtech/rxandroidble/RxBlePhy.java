...
public interface RxBlePhy {
    ...
    /**
     * Returns the PHY mask value.
     *
     * @return corresponds to e.g. {@link BluetoothDevice#PHY_LE_CODED_MASK}
     */
    int getMask();

    /**
     * Returns the PHY value.
     *
     * @return corresponds to e.g. {@link BluetoothDevice#PHY_LE_CODED}
     */
    int getValue();
}
