 ...
 * {@link io.nrbtech.rxandroidble.RxBleConnection#readCharacteristic(UUID)} or
 * {@link io.nrbtech.rxandroidble.RxBleConnection#setupIndication(UUID)}. If the data in emitted byte arrays is stored using
